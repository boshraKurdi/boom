...
import {
  ...
  ActUpdate,
  ActShow
} from "../../../store/Dashboard/Donations/DonationsSlice";
import { ActIndex as ActIndexUsers } from "../../../store/Dashboard/Users/UsersSlice";
import { ActIndex as ActIndexTools } from "../../../store/Dashboard/Tools/ToolsSlice";
...
export default function Operation() {
  ...
  useEffect(() => {
    dispatch(ActIndex());
    dispatch(ActIndexUsers());
    dispatch(ActIndexTools());
  }, [dispatch]);
 const { t } = useTranslation();
  const { data, loading } = useSelector((state) => state.donations);
  ...
  return (
    <div className="operations-container-dashboard">
      ...
      <AddOperationModal
        ...
        input={["cost"]}
        select={[
          { label: "tool_id", data: toolsData },
          { label: "user_id", data: usersData },
        ]}
      />
    </div>
  );
